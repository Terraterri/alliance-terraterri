...
const HostBrandExpo = () => {
  ...
  }, [isModalOpen, verificationStatus, otpTimer]);
          ...
          <div className="container">
              ...
              <div className="col-md-12">
                <div className="property-single-content property-single-contentt2">
                  <h2 className="whyexTitle brline">
                    "Your Expo, Your Brand, Your Way!"
                  </h2>
                  <div className="property-single-description">

                    <p>
                      AirPropX empowers event organizers like you to host seamless, immersive metaverse expos.
                      We understand the challenges faced by event organizers—reaching wider audiences, managing costs, and ensuring high engagement levels
                    </p>
                  </div>
                  <div className="text-center tagline_txt">
                    ...
                    <Carousel>
                      <Carousel.Item>
                        <p className="slid_clr_meta1">"Empower Your Brand with Seamless Expo Hosting."</p>
                      </Carousel.Item>
                      <Carousel.Item>
                        <p className="slid_clr_meta2">"Your Identity, Our Platform, Unlimited Possibilities."</p>
                      </Carousel.Item>
                    </Carousel>
            ...
            <div className="col-md-12 text-center">
              <h2 className="whyexTitle">
                AirPropX is your solution, offering a platform tailored to
              </h2>
            </div>
              ...
              <div className="col-lg-6 col-md-12">
                <div className="overFsrol">
                  <div className="whySubTitle">
                    <h3 className=""><span>»</span>Expand Your Audience Reach</h3>
                    <h5>Harness the power of the metaverse to extend your expo globally, enabling attendees to join from anywhere, unrestricted by travel or location.</h5>
                  </div>
                  <div className="whySubTitle">
                    <h3 className=""><span>»</span>Maximize Engagement</h3>
                    <h5>Create dynamic virtual booths for exhibitors to showcase their properties interactively, while attendees explore, chat with builders, and network in a highly engaging 3D environment.</h5>
                  </div>
                  <div className="whySubTitle">
                    <h3 className=""><span>»</span>Cost-Effective and Scalable</h3>
                    <h5>Significantly reduce physical venue, travel, and logistics costs. Scale your expo effortlessly to accommodate an unlimited number of attendees in the virtual space.</h5>
                  </div>
                  <div className="whySubTitle">
                    <h3 className=""><span>»</span>Real-Time Analytics</h3>
                    <h5>Gain in-depth insights with analytics on attendee activity, helping you and your exhibitors refine strategies, enhance future events, and maximize lead generation.</h5>
                  </div>
                  <div className="whySubTitle">
                    <h3 className=""><span>»</span>Eco-Friendly & Sustainable</h3>
                    <h5>Minimize environmental impact by reducing travel and eliminating printed materials, aligning your event with sustainable practices.</h5>
                  </div>
